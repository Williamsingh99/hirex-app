    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="space-y-0.5">
          <h1 className="text-2xl font-bold text-white tracking-tight">Opportunity Feed</h1>
          <p className="text-white/40 text-sm">AI-curated job matches based on your professional identity.</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="p-2 rounded-full bg-white/5 border border-white/10 text-white/60 hover:text-white transition-all active:scale-95">
            <Filter size={18} />
          </button>
        </div>
      </div>
